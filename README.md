...
- Confirm a project's current state without inventing a field change. Every active project first establishes a truthful review baseline; reviewed projects then use a 3/7/14-day cadence for focus/normal/later priorities and re-enter a neutral review queue when due.
