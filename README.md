...
- Treat a rolled-over task as one continuous work item: earlier daily snapshots remain available as historical evidence, but only the latest record counts as unfinished work for project pause, archive, and closeout decisions.
